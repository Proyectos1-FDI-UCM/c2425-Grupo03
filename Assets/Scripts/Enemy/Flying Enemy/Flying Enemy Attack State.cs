//---------------------------------------------------------
// Script con el estado de ataque del enemigo volador
...
/// </summary>
public class FlyingEnemyAttackState : BaseState
{
    ...
    /// <summary>
    /// El radio de ataque del enemigo
    /// </summary>
    ...
    private void OnDrawGizmos()
    {
        ...
        Gizmos.DrawWireCube(new Vector2(transform.position.x, (transform.position.y - _attackRadius / 2)), new Vector2(1f, _attackRadius));
    }
    #endregion
